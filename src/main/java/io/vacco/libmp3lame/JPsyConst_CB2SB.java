...
final class JPsyConst_CB2SB {
  ...
  final float mld[] =
      new float[(Jencoder.SBMAX_l >= Jencoder.SBMAX_s ? Jencoder.SBMAX_l : Jencoder.SBMAX_s)];
  final float bo_weight[] =
      new float
          [(Jencoder.SBMAX_l >= Jencoder.SBMAX_s
              ? Jencoder.SBMAX_l
              : Jencoder.SBMAX_s)]; /* band weight long scalefactor bands, at transition */
  ...
  int bm[] =
      new int
          [(Jencoder.SBMAX_l >= Jencoder.SBMAX_s
              ? Jencoder.SBMAX_l
              : Jencoder.SBMAX_s)]; // FIXME never uses bm
  ...
  final void copyFrom(final JPsyConst_CB2SB p) {
    ...
    System.arraycopy(
        ...
        this.mld,
        0,
        (Jencoder.SBMAX_l >= Jencoder.SBMAX_s ? Jencoder.SBMAX_l : Jencoder.SBMAX_s));
    System.arraycopy(
        p.bo_weight,
        0,
        this.bo_weight,
