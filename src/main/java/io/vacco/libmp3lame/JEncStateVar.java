...
final class JEncStateVar {
  /* variables for newmdct.c */
  final float sb_sample[][][][] = new float[2][2][18][Jencoder.SBLIMIT];
  ...
  final Jheader header[] = new Jheader[MAX_HEADER_BUF];
  ...
  private static final int MFSIZE = (3 * 1152 + Jencoder.ENCDELAY - Jencoder.MDCTDELAY);
