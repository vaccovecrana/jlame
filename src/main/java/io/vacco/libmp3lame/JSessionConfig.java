...
final class JSessionConfig {
  ...
  /**
   * 0 = ISO model: amplify all distorted bands 1 = amplify within 50% of max (on db scale) 2 =
   * amplify only most distorted band 3 = method 1 and refine with method 2
   */
  int noise_shaping_amp;
  /**
   * 0 = stop at over=0, all scalefacs amplified or a scalefac has reached max value 1 = stop when
   * all scalefacs amplified or a scalefac has reached max value 2 = stop when all scalefacs
   * amplified
   */
