...
public final class Jid3tag {
  ...
  private static final int genre_alpha_map[] = {
    123, 34, 74, 73, 99, 20, 40, 26, 145, 90, 116, 41, 135, 85, 96, 138, 89, 0, 107, 132, 65, 88,
    104, 102, 97, 136, 61, 141, 32, 1, 112, 128, 57, 140, 2, 139, 58, 3, 125, 50, 22, 4, 55, 127,
    122, 120, 98, 52, 48, 54, 124, 25, 84, 80, 115, 81, 119, 5, 30, 36, 59, 126, 38, 49, 91, 6, 129,
    79, 137, 7, 35, 100, 131, 19, 33, 46, 47, 8, 29, 146, 63, 86, 71, 45, 142, 9, 77, 82, 64, 133,
    10, 66, 39, 11, 103, 12, 75, 134, 13, 53, 62, 109, 117, 23, 108, 92, 67, 93, 43, 121, 15, 68,
    14, 16, 76, 87, 118, 17, 78, 143, 114, 110, 69, 21, 111, 95, 105, 42, 37, 24, 56, 44, 101, 83,
    94, 106, 147, 113, 18, 51, 130, 144, 60, 70, 31, 72, 27, 28
  };
  ...
  // private static final int ID_DATE = FRAME_ID('T', 'D', 'A', 'T'); /* "ddMM" */// FIXME never
  // uses ID_VSLT
  // private static final int ID_TIME = FRAME_ID('T', 'I', 'M', 'E'); /* "hhmm" */// FIXME never
  // uses ID_VSLT
  // private static final int ID_TPOS = FRAME_ID('T', 'P', 'O', 'S'); /* '0'-'9' and '/' allowed
  // */// FIXME never uses ID_VSLT
  ...
  // private static final int ID_USLT = FRAME_ID('U', 'S', 'L', 'T'); /* full text string */// FIXME
  // never uses ID_VSLT
  private static final int ID_USER = FRAME_ID('U', 'S', 'E', 'R'); /* full text string */
  private static final int ID_PCST =
      FRAME_ID('P', 'C', 'S', 'T'); /* iTunes Podcast indicator, only presence important */
  private static final int ID_WFED =
  ...
  private static final boolean test_tag_spec_flags(final Jlame_internal_flags gfc, final int tst) {
    return (gfc.tag_spec.flags & tst) != 0;
  }

  private static final boolean is_lame_internal_flags_null(final Jlame_global_flags gfp) {
    return (gfp == null || gfp.internal_flags == null);
  }

  private static final void copyV1ToV2(
      final Jlame_global_flags gfp, final int frame_id, final String s) {
    final Jlame_internal_flags gfc = gfp != null ? gfp.internal_flags : null;
    if (gfc != null) {
  ...
  private static final void id3v2AddLameVersion(final Jlame_global_flags gfp) {
  ...
  private static final void id3v2AddAudioDuration(final Jlame_global_flags gfp, double ms) {
    final JSessionConfig cfg = gfp.internal_flags.cfg; /* caller checked pointers */
    final double max_ulong = (double) Jutil.MAX_U_32_NUM;
    long playlength_ms;
  ...
  public static final void id3tag_genre_list(final Jid3tag_handler h, final Object cookie) {
    if (h != null) {
  ...
  public static final void id3tag_init(final Jlame_global_flags gfp) {
  ...
  public static final void id3tag_add_v2(final Jlame_global_flags gfp) {
    if (is_lame_internal_flags_null(gfp)) {
      return;
    }
    final Jlame_internal_flags gfc = gfp.internal_flags;
  ...
  public static final void id3tag_v1_only(final Jlame_global_flags gfp) {
    if (is_lame_internal_flags_null(gfp)) {
      return;
    }
    final Jlame_internal_flags gfc = gfp.internal_flags;
  ...
  public static final void id3tag_v2_only(final Jlame_global_flags gfp) {
    if (is_lame_internal_flags_null(gfp)) {
      return;
    }
    final Jlame_internal_flags gfc = gfp.internal_flags;
  ...
  public static final void id3tag_space_v1(final Jlame_global_flags gfp) {
    if (is_lame_internal_flags_null(gfp)) {
      return;
    }
    final Jlame_internal_flags gfc = gfp.internal_flags;
  ...
  public static final void id3tag_pad_v2(final Jlame_global_flags gfp) {
    id3tag_set_pad(gfp, 128);
  }

  public static final void id3tag_set_pad(final Jlame_global_flags gfp, final int n) {
    if (is_lame_internal_flags_null(gfp)) {
      return;
    }
    final Jlame_internal_flags gfc = gfp.internal_flags;
  ...
  */
  ...
  public static final int id3tag_set_genre(final Jlame_global_flags gfp, final String text) {
    final Jlame_internal_flags gfc = gfp.internal_flags;
    int ret;
    if (text == null) {
      return -3;
  ...
  public static final int id3tag_set_albumart(
      final Jlame_global_flags gfp, final byte[] image, final int size) {
    if (is_lame_internal_flags_null(gfp)) {
      return 0;
    }
    final Jlame_internal_flags gfc = gfp.internal_flags;
  ...
  */
  ...
  private static final JFrameDataNode findNode(
      final Jid3tag_spec tag, final int frame_id, final JFrameDataNode last) {
    JFrameDataNode node = last != null ? last.nxt : tag.v2_head;
    while (node != null) {
  ...
  private static final void appendNode(final Jid3tag_spec tag, final JFrameDataNode node) {
  ...
  private static final boolean isSameDescriptor(
      final JFrameDataNode node, final byte[] dsc, final boolean isUnicode) {
  ...
  private static final int id3v2_add(
    ...
    if (gfc != null) {
      ...
      JFrameDataNode node = findNode(gfc.tag_spec, frame_id, null);
      ...
      node.dsc = bdesc;
      node.txt =
          Charset.forName("UTF-16LE").encode(text).put(0, (byte) 0xFF).put(1, (byte) 0xFE).array();
  ...
  private static final String id3v2_get_language(final Jlame_global_flags gfp) {
    final Jlame_internal_flags gfc = gfp != null ? gfp.internal_flags : null;
    if (gfc != null) {
  ...
  private static final int id3v2_add_lng(
      final Jlame_global_flags gfp,
      final int frame_id,
      final String desc,
      final String text,
  ...
  private static final int id3tag_set_userinfo(
      final Jlame_global_flags gfp, final int id, final String fieldvalue, final boolean isEncode) {
    int rc = -7;
    final int a = fieldvalue.indexOf('=');
    if (a >= 0) {
      rc =
          id3v2_add_lng(gfp, id, fieldvalue.substring(0, a), fieldvalue.substring(a + 1), isEncode);
    }
    return rc;
  }

  public static final int id3tag_set_textinfo(
      final Jlame_global_flags gfp, final String id, final String text, final boolean isEncode) {
    ...
    if (frame_id == ID_WFED) {
      return id3v2_add_lng(
          gfp, frame_id, text, null, isEncode); /* iTunes expects WFED to be a text frame */
    }
  ...
  public static final int id3tag_set_comment(
      final Jlame_global_flags gfp,
      final String lang,
      final String desc,
      final String text,
  ...
  public static final void id3tag_set_title(final Jlame_global_flags gfp, final String title) {
    final Jlame_internal_flags gfc = gfp != null ? gfp.internal_flags : null;
  ...
  public static final void id3tag_set_artist(final Jlame_global_flags gfp, final String artist) {
    final Jlame_internal_flags gfc = gfp != null ? gfp.internal_flags : null;
  ...
  public static final void id3tag_set_album(final Jlame_global_flags gfp, final String album) {
    final Jlame_internal_flags gfc = gfp != null ? gfp.internal_flags : null;
  ...
  public static final void id3tag_set_year(final Jlame_global_flags gfp, final String year) {
    final Jlame_internal_flags gfc = gfp != null ? gfp.internal_flags : null;
  ...
  public static final void id3tag_set_comment(final Jlame_global_flags gfp, final String comment) {
    final Jlame_internal_flags gfc = gfp != null ? gfp.internal_flags : null;
  ...
  public static final int id3tag_set_track(final Jlame_global_flags gfp, final String track) {
    final Jlame_internal_flags gfc = gfp != null ? gfp.internal_flags : null;
    int ret = 0;
  ...
  */
  ...
  private static final int sizeOfNode(final JFrameDataNode node) {
    int n = 0;
    if (node != null) {
      n = 10; /* header size */
  ...
  private static final int sizeOfCommentNode(final JFrameDataNode node) {
    int n = 0;
    if (node != null) {
      n = 10; /* header size */
      n += 1; /* text encoding flag */
  ...
  private static final int sizeOfWxxxNode(final JFrameDataNode node) {
    int n = 0;
    if (node != null) {
      n = 10; /* header size */
      if (node.dsc.length > 0) {
  ...
  private static final int writeChars(
      final byte[] buffer, int frame, final byte[] str, final int n) {
    for (int i = 0; i < n; i++) {
      buffer[frame++] = str[i];
    }
    return frame;
  ...
  private static final int set_frame_comment(
      final byte[] buffer, int frame, final JFrameDataNode node) {
  ...
  private static final int set_frame_custom2(
      final byte[] buffer, int frame, final JFrameDataNode node) {
  ...
  private static final int set_frame_wxxx(
      final byte[] buffer, int frame, final JFrameDataNode node) {
  ...
  private static final int set_frame_apic(
      final byte[] buffer, int frame, final byte[] mimetype, final byte[] data) // , final int size)
      {
  ...
  public static final int id3tag_set_fieldvalue(
      final Jlame_global_flags gfp, final String fieldvalue, final boolean isEncode) {
    if (is_lame_internal_flags_null(gfp)) {
      return 0;
    }
    if (fieldvalue != null && fieldvalue.length() != 0) {
      ...
      if (frame_id != 0) {
        ...
        final int rc =
            id3tag_set_textinfo(gfp, fieldvalue.substring(0, 4), fieldvalue.substring(5), isEncode);
        return rc;
      }
    }
    return -1;
  ...
  public static final int lame_get_id3v2_tag(
      final Jlame_global_flags gfp, final byte[] buffer, final int size) {
    if (is_lame_internal_flags_null(gfp)) {
      return 0;
    }
    final Jlame_internal_flags gfc = gfp.internal_flags;
    ...
    }
    {
      ...
      if (usev2) {
        if (gfp.num_samples != Jutil.MAX_U_32_NUM) {
        ...
        if (gfc.tag_spec.albumart != null) { // && gfc.tag_spec.albumart_size != 0 ) {
          ...
          if (albumart_mime != null) {
            tag_size +=
                10
                    + 4
                    + albumart_mime.length
                    + gfc.tag_spec.albumart.length; // gfc.tag_spec.albumart_size;
          }
        }
        {
          final Jid3tag_spec tag = gfc.tag_spec;
          if (tag.v2_head != null) {
            for (JFrameDataNode node = tag.v2_head; node != null; node = node.nxt) {
        ...
        if (albumart_mime != null) {
          p =
              set_frame_apic(
                  buffer, p, albumart_mime, gfc.tag_spec.albumart); // gfc.tag_spec.albumart_size );
        }
  ...
  static final int id3tag_write_v2(final Jlame_global_flags gfp) {
    if (is_lame_internal_flags_null(gfp)) {
      return 0;
    }
    final Jlame_internal_flags gfc = gfp.internal_flags;
    ...
    if (test_tag_spec_flags(gfc, CHANGED_FLAG)) {
      ...
      if (tag_size > n) {
        ...
        for (int i = 0; i < tag_size; ++i) {
          Jbitstream.add_dummy_byte(gfc, tag[i], 1);
        }
      }
  ...
  private static final int set_text_field(
      final byte[] field, int foffset, final byte[] text, int size, final int pad) {
    int toffset = 0;
  ...
  public static final int lame_get_id3v1_tag(
      final Jlame_global_flags gfp, final byte[] buffer, final int size) {
    if (gfp == null) {
      return 0;
    }
    ...
    if (test_tag_spec_flags(gfc, CHANGED_FLAG)) {
      ...
      p =
          set_text_field(
              buffer,
              p,
              gfc.tag_spec.year != 0 ? Integer.toString(gfc.tag_spec.year).getBytes() : null,
              4,
              pad);
      /* limit comment field to 28 bytes if a track is specified */
      p =
          set_text_field(
              buffer, p, gfc.tag_spec.comment, gfc.tag_spec.track_id3v1 != 0 ? 28 : 30, pad);
  ...
  static final int id3tag_write_v1(final Jlame_global_flags gfp) {
    if (is_lame_internal_flags_null(gfp)) {
      return 0;
    }
    final Jlame_internal_flags gfc = gfp.internal_flags;
