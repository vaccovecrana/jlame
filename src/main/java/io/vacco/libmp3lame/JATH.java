...
/**
 * ATH related stuff, if something new ATH related has to be added, please plugg it here into the
 * ATH_t struct
 */
final class JATH {
  ...
  int use_adjust;
  /**
   * factor for tuning the (sample power) point below which adaptive threshold of hearing adjustment
   * occurs
   */
