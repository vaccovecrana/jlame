...
public final class Jlame_global_flags { // struct lame_global_struct
   ...
   *
   * <p>Default is compression ratio of 11.
   */
  public final int lame_set_brate(final int bitrate) {
    if (is_lame_global_flags_valid()) {
      this.brate = bitrate;
      if (bitrate > 320) {
  ...
  public final int lame_get_brate() {
    if (is_lame_global_flags_valid()) {
      return this.brate;
    }
    return 0;
  ...
  public final int lame_set_compression_ratio(final float ratio) {
    if (is_lame_global_flags_valid()) {
  ...
  public final float lame_get_compression_ratio() {
    if (is_lame_global_flags_valid()) {
  ...
  public final int lame_set_copyright(final boolean is_copyright) {
    if (is_lame_global_flags_valid()) {
      /* default = 0 (disabled) */
  ...
  public final boolean lame_get_copyright() {
    if (is_lame_global_flags_valid()) {
  ...
  /** Mark as original. */
  public final int lame_set_original(final boolean is_original) {
    if (is_lame_global_flags_valid()) {
      /* default = 1 (enabled) */
  ...
  public final boolean lame_get_original() {
    if (is_lame_global_flags_valid()) {
   ...
   */
  public final int lame_set_error_protection(final boolean is_error_protection) {
    if (is_lame_global_flags_valid()) {
      /* default = 0 (disabled) */
  ...
  public final boolean lame_get_error_protection() {
    if (is_lame_global_flags_valid()) {
  ...
  public final int lame_set_extension(final boolean is_extension) {
    if (is_lame_global_flags_valid()) {
      /* default = 0 (disabled) */
  ...
  public final boolean lame_get_extension() {
    if (is_lame_global_flags_valid()) {
  ...
  public final int lame_set_strict_ISO(final int val) {
    if (is_lame_global_flags_valid()) {
      /* default = 0 (disabled) */
      /* enforce disable/enable meaning, if we need more than two values
      we need to switch to an enum to have an apropriate representation
      of the possible meanings of the value */
      if (val < Jlame.MDB_DEFAULT || Jlame.MDB_MAXIMUM < val) {
        return -1;
      }
      this.strict_ISO = val;
      return 0;
  ...
  public final int lame_get_strict_ISO() {
    if (is_lame_global_flags_valid()) {
  ...
  public final int lame_set_disable_reservoir(final boolean is_disable_reservoir) {
    if (is_lame_global_flags_valid()) {
      /* default = 0 (disabled) */
  ...
  public final boolean lame_get_disable_reservoir() {
    if (is_lame_global_flags_valid()) {
  ...
  public final int lame_set_experimentalX(final int experimentalX) {
    if (is_lame_global_flags_valid()) {
      lame_set_quant_comp(experimentalX);
      lame_set_quant_comp_short(experimentalX);
      return 0;
    }
    return -1;
  }

  public final int lame_get_experimentalX() {
    return lame_get_quant_comp();
  }

  /** Select a different "best quantization" function. default = 0 */
  public final int lame_set_quant_comp(final int quant_type) {
    if (is_lame_global_flags_valid()) {
  ...
  public final int lame_get_quant_comp() {
    if (is_lame_global_flags_valid()) {
  ...
  /** Select a different "best quantization" function. default = 0 */
  public final int lame_set_quant_comp_short(final int quant_type) {
    if (is_lame_global_flags_valid()) {
  ...
  public final int lame_get_quant_comp_short() {
    if (is_lame_global_flags_valid()) {
  ...
  public final int lame_set_experimentalY(final boolean is_experimentalY) {
    if (is_lame_global_flags_valid()) {
  ...
  public final boolean lame_get_experimentalY() {
    if (is_lame_global_flags_valid()) {
  ...
  public final int lame_set_experimentalZ(final boolean is_experimentalZ) {
    if (is_lame_global_flags_valid()) {
  ...
  public final boolean lame_get_experimentalZ() {
    if (is_lame_global_flags_valid()) {
  ...
  public final int lame_set_exp_nspsytune(final int nspsytune) {
    if (is_lame_global_flags_valid()) {
      // default = 0 (disabled)
  ...
  public final int lame_get_exp_nspsytune() {
    if (is_lame_global_flags_valid()) {
  ...
  public final int lame_set_VBR(final int /* vbr_mode */ vbr_mode) {
    if (is_lame_global_flags_valid()) {
      final int vbr_q = vbr_mode;
      if (0 > vbr_q || Jlame.vbr_max_indicator <= vbr_q) {
  ...
  public final int /* vbr_mode */ lame_get_VBR() {
    if (is_lame_global_flags_valid()) {
      return this.VBR;
    }
    return Jlame.vbr_off;
  }

  /** VBR quality level. 0 = highest 9 = lowest */
  public final int lame_set_VBR_q(int vbr_quality) {
    if (is_lame_global_flags_valid()) {
      int ret = 0;
  ...
  public final int lame_get_VBR_q() {
    if (is_lame_global_flags_valid()) {
      return this.VBR_q;
    }
    return 0;
  ...
  public final int lame_set_VBR_quality(float vbr_quality) {
    if (is_lame_global_flags_valid()) {
      int ret = 0;
  ...
  public final float lame_get_VBR_quality() {
    if (is_lame_global_flags_valid()) {
  ...
  public final int lame_set_VBR_mean_bitrate_kbps(final int vbr_mean_bitrate_kbps) {
    if (is_lame_global_flags_valid()) {
  ...
  public final int lame_get_VBR_mean_bitrate_kbps() {
    if (is_lame_global_flags_valid()) {
  ...
  public final int lame_set_VBR_min_bitrate_kbps(final int vbr_min_bitrate_kbps) {
    if (is_lame_global_flags_valid()) {
  ...
  public final int lame_get_VBR_min_bitrate_kbps() {
    if (is_lame_global_flags_valid()) {
  ...
  public final int lame_set_VBR_max_bitrate_kbps(final int vbr_max_bitrate_kbps) {
    if (is_lame_global_flags_valid()) {
  ...
  public final int lame_get_VBR_max_bitrate_kbps() {
    if (is_lame_global_flags_valid()) {
  ...
  /** Strictly enforce VBR_min_bitrate. Normally it will be violated for analog silence. */
  public final int lame_set_VBR_hard_min(final boolean vbr_hard_min) {
    if (is_lame_global_flags_valid()) {
      /* default = 0 (disabled) */
  ...
  public final boolean lame_get_VBR_hard_min() {
    if (is_lame_global_flags_valid()) {
  ...
  /** Freqency in Hz to apply lowpass. 0 = default = lame chooses -1 = disabled */
  public final int lame_set_lowpassfreq(final int lowpass_freq) {
    if (is_lame_global_flags_valid()) {
  ...
  public final int lame_get_lowpassfreq() {
    if (is_lame_global_flags_valid()) {
  ...
  public final int lame_set_lowpasswidth(final int lowpass_width) {
    if (is_lame_global_flags_valid()) {
  ...
  public final int lame_get_lowpasswidth() {
    if (is_lame_global_flags_valid()) {
  ...
  /** Frequency in Hz to apply highpass. 0 = default = lame chooses -1 = disabled */
  public final int lame_set_highpassfreq(final int highpass_freq) {
    if (is_lame_global_flags_valid()) {
  ...
  public final int lame_get_highpassfreq() {
    if (is_lame_global_flags_valid()) {
  ...
  /** Width of transition band (in Hz). default = one polyphase filter band */
  public final int lame_set_highpasswidth(final int highpass_width) {
    if (is_lame_global_flags_valid()) {
  ...
  public final int lame_get_highpasswidth() {
    if (is_lame_global_flags_valid()) {
  ...
  public final float lame_get_maskingadjust() {
    if (is_lame_global_flags_valid()) {
  ...
  public final float lame_get_maskingadjust_short() {
    if (is_lame_global_flags_valid()) {
  ...
  public final int lame_set_ATHonly(final boolean is_ATHonly) {
    if (is_lame_global_flags_valid()) {
  ...
  public final boolean lame_get_ATHonly() {
    if (is_lame_global_flags_valid()) {
      return this.ATHonly;
    }
    return false;
  ...
  /** Only use ATH for short blocks. */
  public final int lame_set_ATHshort(final boolean is_ATHshort) {
    if (is_lame_global_flags_valid()) {
  ...
  public final boolean lame_get_ATHshort() {
    if (is_lame_global_flags_valid()) {
  ...
  /** Disable ATH. */
  public final int lame_set_noATH(final boolean is_noATH) {
    if (is_lame_global_flags_valid()) {
      this.noATH = is_noATH;
      return 0;
    }
  ...
  public final boolean lame_get_noATH() {
    if (is_lame_global_flags_valid()) {
      return this.noATH;
    }
    return false;
  ...
  /** Select ATH formula. */
  public final int lame_set_ATHtype(final int is_ATHtype) {
    if (is_lame_global_flags_valid()) {
  ...
  public final int lame_get_ATHtype() {
    if (is_lame_global_flags_valid()) {
      return this.ATHtype;
    }
    return 0;
  ...
  public final int lame_set_ATHcurve(final float is_ATHcurve) {
    if (is_lame_global_flags_valid()) {
  ...
  public final float lame_get_ATHcurve() {
    if (is_lame_global_flags_valid()) {
  ...
  /** Lower ATH by this many db. */
  public final int lame_set_ATHlower(final float ATHlower) {
    if (is_lame_global_flags_valid()) {
  ...
  public final float lame_get_ATHlower() {
    if (is_lame_global_flags_valid()) {
  ...
  public final int lame_set_athaa_type(final int ATHaa_type) {
    if (is_lame_global_flags_valid()) {
  ...
  public final int lame_get_athaa_type() {
    if (is_lame_global_flags_valid()) {
  ...
  public final int lame_set_athaa_sensitivity(final float ATHaa_sensitivity) {
    if (is_lame_global_flags_valid()) {
  ...
  public final float lame_get_athaa_sensitivity() {
    if (is_lame_global_flags_valid()) {
  ...
  /*public final int lame_set_cwlimit(final int cwlimit) {
  	return 0;
  }

  public final int lame_get_cwlimit() {
  	return 0;
  }*/
  ...
  public final int lame_set_allow_diff_short(final boolean allow_diff_short) {
    if (is_lame_global_flags_valid()) {
      this.short_blocks =
          allow_diff_short
              ? Jlame_global_flags.short_block_allowed
  ...
  public final int lame_get_allow_diff_short() {
    if (is_lame_global_flags_valid()) {
      if (this.short_blocks == Jlame_global_flags.short_block_allowed) {
  ...
  /** Use temporal masking effect */
  public final int lame_set_useTemporal(final boolean is_useTemporal) {
    if (is_lame_global_flags_valid()) {
      /* default = 1 (enabled) */
  ...
  public final boolean lame_get_useTemporal() {
    if (is_lame_global_flags_valid()) {
  ...
  public final int lame_set_interChRatio(final float ratio) {
    if (is_lame_global_flags_valid()) {
  ...
  public final float lame_get_interChRatio() {
    if (is_lame_global_flags_valid()) {
  ...
  public final int lame_set_substep(final int method) {
    if (is_lame_global_flags_valid()) {
  ...
  public final int lame_get_substep() {
    if (is_lame_global_flags_valid()) {
  ...
  /** scalefactors scale */
  public final int lame_set_sfscale(final boolean val) {
    if (is_lame_global_flags_valid()) {
  ...
  public final boolean lame_get_sfscale() {
    if (is_lame_global_flags_valid()) {
  ...
  /** subblock gain */
  public final int lame_set_subblock_gain(final int sbgain) {
    if (is_lame_global_flags_valid()) {
  ...
  public final int lame_get_subblock_gain() {
    if (is_lame_global_flags_valid()) {
  ...
  public final int lame_set_no_short_blocks(final boolean no_short_blocks) {
    if (is_lame_global_flags_valid()) {
      this.short_blocks =
          no_short_blocks
              ? Jlame_global_flags.short_block_dispensed
              : Jlame_global_flags.short_block_allowed;
      return 0;
    }
    return -1;
  ...
  public final int lame_get_no_short_blocks() {
    if (is_lame_global_flags_valid()) {
      switch (this.short_blocks) {
        default:
        case Jlame_global_flags.short_block_not_set:
          return -1;
        case Jlame_global_flags.short_block_dispensed:
          return 1;
        case Jlame_global_flags.short_block_allowed:
        case Jlame_global_flags.short_block_coupled:
        case Jlame_global_flags.short_block_forced:
          return 0;
      }
    }
    return -1;
  ...
  /** Force short blocks. */
  public int lame_set_force_short_blocks(final boolean is_short_blocks) {
    if (is_lame_global_flags_valid()) {
      /* enforce disable/enable meaning, if we need more than two values
      we need to switch to an enum to have an apropriate representation
      of the possible meanings of the value */
      ...
      if (is_short_blocks) {
        this.short_blocks = Jlame_global_flags.short_block_forced;
      } else if (this.short_blocks == Jlame_global_flags.short_block_forced) {
        this.short_blocks = Jlame_global_flags.short_block_allowed;
      }
  ...
  public final int lame_get_force_short_blocks() {
    if (is_lame_global_flags_valid()) {
      switch (this.short_blocks) {
        default:
        case Jlame_global_flags.short_block_not_set:
  ...
  public final int lame_set_short_threshold_lrm(final float lrm) {
    if (is_lame_global_flags_valid()) {
      this.attackthre = lrm;
      return 0;
    }
  ...
  public final float lame_get_short_threshold_lrm() {
    if (is_lame_global_flags_valid()) {
  ...
  public final int lame_set_short_threshold_s(final float s) {
    if (is_lame_global_flags_valid()) {
      this.attackthre_s = s;
      return 0;
    }
  ...
  public final float lame_get_short_threshold_s() {
    if (is_lame_global_flags_valid()) {
  ...
  public final int lame_set_short_threshold(final float lrm, final float s) {
    if (is_lame_global_flags_valid()) {
   ...
   *
   * <p>It is STRONGLY not recommended to use this, because psycho does not take it into account,
   * and last but not least many decoders ignore these bits
   */
  public final int lame_set_emphasis(final int emphasis_val) {
    if (is_lame_global_flags_valid()) {
  ...
  public final int lame_get_emphasis() {
    if (is_lame_global_flags_valid()) {
  ...
  public final int lame_get_version() {
    if (is_lame_global_flags_valid()) {
      final Jlame_internal_flags gfc = this.internal_flags;
  ...
  /** Encoder delay. */
  public final int lame_get_encoder_delay() {
    if (is_lame_global_flags_valid()) {
      final Jlame_internal_flags gfc = this.internal_flags;
      if (gfc.is_lame_internal_flags_valid()) {
  ...
  /**
   * padding appended to the input to make sure decoder can fully decode all input. Note that this
   * value can only be calculated during the call to lame_encoder_flush(). Before
   * lame_encoder_flush() has been called, the value of encoder_padding = 0.
   */
  public final int lame_get_encoder_padding() {
    if (is_lame_global_flags_valid()) {
      final Jlame_internal_flags gfc = this.internal_flags;
      if (gfc.is_lame_internal_flags_valid()) {
  ...
  /** Size of MPEG frame. */
  public final int lame_get_framesize() {
    if (is_lame_global_flags_valid()) {
      final Jlame_internal_flags gfc = this.internal_flags;
      if (gfc.is_lame_internal_flags_valid()) {
  ...
  public final int lame_get_frameNum() {
    if (is_lame_global_flags_valid()) {
      final Jlame_internal_flags gfc = this.internal_flags;
      if (gfc.is_lame_internal_flags_valid()) {
  ...
  public final int lame_get_mf_samples_to_encode() {
    if (is_lame_global_flags_valid()) {
      final Jlame_internal_flags gfc = this.internal_flags;
      if (gfc.is_lame_internal_flags_valid()) {
  ...
  /**
   * size (bytes) of mp3 data buffered, but not yet encoded. this is the number of bytes which would
   * be output by a call to lame_encode_flush_nogap. NOTE: lame_encode_flush() will return more
   * bytes than this because it will encode the reamining buffered PCM samples before flushing the
   * mp3 buffers.
   */
  public final int lame_get_size_mp3buffer() {
    if (is_lame_global_flags_valid()) {
      final Jlame_internal_flags gfc = this.internal_flags;
      if (gfc.is_lame_internal_flags_valid()) {
        final int size = (int) (Jbitstream.compute_flushbits(gfc /*, &size */) >> 32);
        return size;
      }
    }
    return 0;
  ...
  /**
   * LAME's estimate of the total number of frames to be encoded. Only valid if calling program set
   * num_samples.
   */
  public final int lame_get_totalframes() {
    if (is_lame_global_flags_valid()) {
      final Jlame_internal_flags gfc = this.internal_flags;
      if (gfc.is_lame_internal_flags_valid()) {
        final JSessionConfig cfg = gfc.cfg;
  ...
  public final int lame_set_preset(final int preset_val) {
    if (is_lame_global_flags_valid()) {
      this.preset = preset_val;
      return Jpresets.apply_preset(this, preset_val, true);
    }
    return -1;
  }

  public final void lame_set_write_id3tag_automatic(final boolean v) {
    if (is_lame_global_flags_valid()) {
      this.write_id3tag_automatic = v;
    }
  }

  public final boolean lame_get_write_id3tag_automatic() {
    if (is_lame_global_flags_valid()) {
  ...
  */
  ...
  /* Custom msfix hack */
  final void lame_set_msfix(final float msfix_val) {
    if (is_lame_global_flags_valid()) {
      /* default = 0 */
  ...
  /*
  	final int lame_set_preset_notune(final int preset_notune) {
  		return 0;
  	}
  */
}
