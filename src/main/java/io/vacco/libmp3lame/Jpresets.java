...
final class Jpresets {
  ...
  */
  ...
  private static final class Jvbr_presets {
    ...
    Jvbr_presets(
        final int ivbr_q,
        final int iquant_comp,
        final int iquant_comp_s,
        final boolean iexpY,
        final float ist_lrm,
        final float ist_s,
        final float imasking_adj,
        final float imasking_adj_short,
        final float iath_lower,
        final float iath_curve,
        final float iath_sensitivity,
        final float iinterch,
        final int isafejoint,
        final int isfb21mod,
        final float imsfix,
        final float iminval,
        final float iath_fixpoint) {
      this.vbr_q = ivbr_q;
  ...
  private static final Jvbr_presets vbr_old_switch_map[] = {
    ...
    new Jvbr_presets(
        0, 9, 9, false, 5.20f, 125.0f, -4.2f, -6.3f, 4.8f, 1f, 0, 0f, 2, 21, 0.97f, 5, 100),
    new Jvbr_presets(
        1, 9, 9, false, 5.30f, 125.0f, -3.6f, -5.6f, 4.5f, 1.5f, 0, 0f, 2, 21, 1.35f, 5, 100),
    new Jvbr_presets(
        2, 9, 9, false, 5.60f, 125.0f, -2.2f, -3.5f, 2.8f, 2f, 0, 0f, 2, 21, 1.49f, 5, 100),
    new Jvbr_presets(
        3, 9, 9, true, 5.80f, 130.0f, -1.8f, -2.8f, 2.6f, 3f, -4, 0f, 2, 20, 1.64f, 5, 100),
    new Jvbr_presets(
        4, 9, 9, true, 6.00f, 135.0f, -0.7f, -1.1f, 1.1f, 3.5f, -8, 0f, 2, 0, 1.79f, 5, 100),
    new Jvbr_presets(
        5, 9, 9, true, 6.40f, 140.0f, 0.5f, 0.4f, -7.5f, 4f, -12, 0.0002f, 0, 0, 1.95f, 5, 100),
    new Jvbr_presets(
        6, 9, 9, true, 6.60f, 145.0f, 0.67f, 0.65f, -14.7f, 6.5f, -19, 0.0004f, 0, 0, 2.30f, 5,
        100),
    new Jvbr_presets(
        7, 9, 9, true, 6.60f, 145.0f, 0.8f, 0.75f, -19.7f, 8f, -22, 0.0006f, 0, 0, 2.70f, 5, 100),
    new Jvbr_presets(
        8, 9, 9, true, 6.60f, 145.0f, 1.2f, 1.15f, -27.5f, 10f, -23, 0.0007f, 0, 0, 0f, 5, 100),
    new Jvbr_presets(
        9, 9, 9, true, 6.60f, 145.0f, 1.6f, 1.6f, -36f, 11f, -25, 0.0008f, 0, 0, 0f, 5, 100),
    new Jvbr_presets(
        10, 9, 9, true, 6.60f, 145.0f, 2.0f, 2.0f, -36f, 12f, -25, 0.0008f, 0, 0, 0f, 5, 100)
  };
  ...
  private static final Jvbr_presets vbr_mt_psy_switch_map[] = {
    ...
    new Jvbr_presets(
        0, 9, 9, false, 4.20f, 25.0f, -6.8f, -6.8f, 7.1f, 1f, 0, 0, 2, 31, 1.000f, 5, 100f),
    new Jvbr_presets(
        1, 9, 9, false, 4.20f, 25.0f, -4.8f, -4.8f, 5.4f, 1.4f, -1, 0, 2, 27, 1.122f, 5, 98f),
    new Jvbr_presets(
        2, 9, 9, false, 4.20f, 25.0f, -2.6f, -2.6f, 3.7f, 2.0f, -3, 0, 2, 23, 1.288f, 5, 97f),
    new Jvbr_presets(
        3, 9, 9, true, 4.20f, 25.0f, -1.6f, -1.6f, 2.0f, 2.0f, -5, 0, 2, 18, 1.479f, 5, 96f),
    new Jvbr_presets(
        4, 9, 9, true, 4.20f, 25.0f, -0.0f, -0.0f, 0.0f, 2.0f, -8, 0, 2, 12, 1.698f, 5, 95f),
    new Jvbr_presets(
        5, 9, 9, true, 4.20f, 25.0f, 1.3f, 1.3f, -6f, 3.5f, -11, 0f, 2, 8, 1.950f, 5, 94.2f),
    /*#if 0
    ...
    #else */
    new Jvbr_presets(
        6, 9, 9, true, 4.50f, 100.0f, 2.2f, 2.3f, -12.0f, 6.0f, -14, 0, 2, 4, 2.239f, 3, 93.9f),
    new Jvbr_presets(
        7, 9, 9, true, 4.80f, 200.0f, 2.7f, 2.7f, -18.0f, 9.0f, -17, 0, 2, 0, 2.570f, 1, 93.6f),
    // #endif
    new Jvbr_presets(
        8, 9, 9, true, 5.30f, 300.0f, 2.8f, 2.8f, -21.0f, 10.0f, -23, 0.0002f, 0, 0, 2.951f, 0,
        93.3f),
    new Jvbr_presets(
        9, 9, 9, true, 6.60f, 300.0f, 2.8f, 2.8f, -23.0f, 11.0f, -25, 0.0006f, 0, 0, 3.388f, 0,
        93.3f),
    new Jvbr_presets(
        10, 9, 9, true, 25.00f, 300.0f, 2.8f, 2.8f, -25.0f, 12.0f, -27, 0.0025f, 0, 0, 3.500f, 0,
        93.3f)
  };
  ...
  private static final void apply_vbr_preset(
      final Jlame_global_flags gfp, final int a, final boolean enforce) {
  ...
  private static final Jabr_presets abr_switch_map[] = {
    ...
    new Jabr_presets(
        8, 9, 9, 0, 0f, 6.60f, 145, 0.95f, 0, -30.0f, 11f, 0.0012f,
  ...
  private static final int apply_abr_preset(
      final Jlame_global_flags gfp, final int preset, final boolean enforce) {
