...
import io.vacco.jlame.spi.convert.Mp3_FormatConversionProvider;
...
public class Mp3_AudioFileReader extends AudioFileReader {
  ...
  public AudioFileFormat getAudioFileFormat(final InputStream stream)
    ...
    final AudioFormat af =
        new AudioFormat(
            Mp3_FormatConversionProvider.ENCODING,
            rate,
    ...
    final AudioFileFormat aff =
        new AudioFileFormat(new AudioFileFormat.Type("MPEG", ""), af, AudioSystem.NOT_SPECIFIED);
    return aff;
  }
  ...
  public AudioInputStream getAudioInputStream(final InputStream stream)
    ...
    // Jformat.FLAC__MAX_BLOCK_SIZE * 2 );// possible resources leak
    try {
