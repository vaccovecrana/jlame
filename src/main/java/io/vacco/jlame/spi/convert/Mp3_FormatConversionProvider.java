package io.vacco.jlame.spi.convert;
    ...
    if (sourceFormat.getEncoding().equals(ENCODING) && (channels == 2 || channels == 1)) {
      if (targetEncoding == Encoding.PCM_SIGNED) {
        final AudioFormat af[] = {
          ...
          new AudioFormat(
              sourceFormat.getSampleRate(), 24, sourceFormat.getChannels(), true, false),
      ...
      if (targetEncoding == Encoding.PCM_UNSIGNED) {
        final AudioFormat af[] = {
          ...
          new AudioFormat(
              sourceFormat.getSampleRate(), 24, sourceFormat.getChannels(), false, false),
          new AudioFormat(
              sourceFormat.getSampleRate(), 24, sourceFormat.getChannels(), false, true),
          new AudioFormat(
              sourceFormat.getSampleRate(), 8, sourceFormat.getChannels(), false, false),
