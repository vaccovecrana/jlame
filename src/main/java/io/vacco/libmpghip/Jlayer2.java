...
final class Jlayer2 {
  ...
  static final void hip_init_tables_layer2() {
    ...
    for (int k = 0; k < 27; k++) {
      ...
      final float table[] = Jmpstr_tag.muls[k];
      int ti = 0;
  ...
  private static final class Jsideinfo_layer_II {
    private final byte allocation[][] = new byte[Jmpg123.SBLIMIT][2];
    private final byte scalefactor[][][] =
        new byte[Jmpg123.SBLIMIT][2][3]; /* subband / channel / block */
  }
  ;

  private static final void II_step_one(
      final Jmpstr_tag mp, final Jsideinfo_layer_II si, final Jframe frame) {
    final int nch = frame.stereo;
    final int sblimit = frame.II_sblimit;
    int jsbound =
        (frame.mode == Jmpg123.MPG_MD_JOINT_STEREO) ? (frame.mode_ext << 2) + 4 : frame.II_sblimit;
    final Jal_table2[] fr_alloc = frame.alloc;
    int alloc1 = 0; // fr_alloc[ alloc1 ]
    final byte scfsi[][] = new byte[Jmpg123.SBLIMIT][2];
  ...
  private static final void II_step_two(
      final Jmpstr_tag mp,
      final Jsideinfo_layer_II si,
      final Jframe frame,
      final int gr,
      final float fraction[][][] /*[2][4][SBLIMIT]*/) {
    final Jal_table2[] fr_alloc = frame.alloc;
    int alloc1 = 0; // fr_alloc[ alloc1 ]
    ...
    for (int i = 0; i < jsbound; ++i) {
      ...
      for (int ch = 0; ch < nch; ++ch) {
        ...
        if (ba != 0) {
          ...
          final Jal_table2 alloc2 = fr_alloc[alloc1 + ba];
          short k = alloc2.bits;
          ...
          if (d1 < 0) {
            ...
            // final unsigned char *tab = Jcommon.grp_table_select( d1, idx );
            //
            byte[] tab;
            switch (d1) {
              case 3:
    ...
    for (int ch = 0; ch < nch; ++ch) {
      for (int i = sblimit; i < Jmpg123.SBLIMIT; ++i) {
        final float[][] fraction_ch = fraction[ch]; // java
        fraction_ch[0][i] = fraction_ch[1][i] = fraction_ch[2][i] = 0.0f;
      }
    }
  ...
  private static final Jal_table2 alloc_0[] = {
    new Jal_table2(4, 0), new Jal_table2(5, 3), new Jal_table2(3, -3), new Jal_table2(4, -7),
        new Jal_table2(5, -15),
    new Jal_table2(6, -31), new Jal_table2(7, -63), new Jal_table2(8, -127),
        new Jal_table2(9, -255), new Jal_table2(10, -511),
    new Jal_table2(11, -1023), new Jal_table2(12, -2047), new Jal_table2(13, -4095),
        new Jal_table2(14, -8191), new Jal_table2(15, -16383),
    new Jal_table2(16, -32767), new Jal_table2(4, 0), new Jal_table2(5, 3), new Jal_table2(3, -3),
        new Jal_table2(4, -7),
    new Jal_table2(5, -15), new Jal_table2(6, -31), new Jal_table2(7, -63), new Jal_table2(8, -127),
        new Jal_table2(9, -255),
    new Jal_table2(10, -511), new Jal_table2(11, -1023), new Jal_table2(12, -2047),
        new Jal_table2(13, -4095), new Jal_table2(14, -8191),
    new Jal_table2(15, -16383), new Jal_table2(16, -32767), new Jal_table2(4, 0),
        new Jal_table2(5, 3), new Jal_table2(3, -3),
    new Jal_table2(4, -7), new Jal_table2(5, -15), new Jal_table2(6, -31), new Jal_table2(7, -63),
        new Jal_table2(8, -127),
    new Jal_table2(9, -255), new Jal_table2(10, -511), new Jal_table2(11, -1023),
        new Jal_table2(12, -2047), new Jal_table2(13, -4095),
    new Jal_table2(14, -8191), new Jal_table2(15, -16383), new Jal_table2(16, -32767),
        new Jal_table2(4, 0), new Jal_table2(5, 3),
    new Jal_table2(7, 5), new Jal_table2(3, -3), new Jal_table2(10, 9), new Jal_table2(4, -7),
        new Jal_table2(5, -15),
    new Jal_table2(6, -31), new Jal_table2(7, -63), new Jal_table2(8, -127),
        new Jal_table2(9, -255), new Jal_table2(10, -511),
    new Jal_table2(11, -1023), new Jal_table2(12, -2047), new Jal_table2(13, -4095),
        new Jal_table2(16, -32767), new Jal_table2(4, 0),
    new Jal_table2(5, 3), new Jal_table2(7, 5), new Jal_table2(3, -3), new Jal_table2(10, 9),
        new Jal_table2(4, -7),
    new Jal_table2(5, -15), new Jal_table2(6, -31), new Jal_table2(7, -63), new Jal_table2(8, -127),
        new Jal_table2(9, -255),
    new Jal_table2(10, -511), new Jal_table2(11, -1023), new Jal_table2(12, -2047),
        new Jal_table2(13, -4095), new Jal_table2(16, -32767),
    new Jal_table2(4, 0), new Jal_table2(5, 3), new Jal_table2(7, 5), new Jal_table2(3, -3),
        new Jal_table2(10, 9),
    new Jal_table2(4, -7), new Jal_table2(5, -15), new Jal_table2(6, -31), new Jal_table2(7, -63),
        new Jal_table2(8, -127),
    new Jal_table2(9, -255), new Jal_table2(10, -511), new Jal_table2(11, -1023),
        new Jal_table2(12, -2047), new Jal_table2(13, -4095),
    new Jal_table2(16, -32767), new Jal_table2(4, 0), new Jal_table2(5, 3), new Jal_table2(7, 5),
        new Jal_table2(3, -3),
    new Jal_table2(10, 9), new Jal_table2(4, -7), new Jal_table2(5, -15), new Jal_table2(6, -31),
        new Jal_table2(7, -63),
    new Jal_table2(8, -127), new Jal_table2(9, -255), new Jal_table2(10, -511),
        new Jal_table2(11, -1023), new Jal_table2(12, -2047),
    new Jal_table2(13, -4095), new Jal_table2(16, -32767), new Jal_table2(4, 0),
        new Jal_table2(5, 3), new Jal_table2(7, 5),
    new Jal_table2(3, -3), new Jal_table2(10, 9), new Jal_table2(4, -7), new Jal_table2(5, -15),
        new Jal_table2(6, -31),
    new Jal_table2(7, -63), new Jal_table2(8, -127), new Jal_table2(9, -255),
        new Jal_table2(10, -511), new Jal_table2(11, -1023),
    new Jal_table2(12, -2047), new Jal_table2(13, -4095), new Jal_table2(16, -32767),
        new Jal_table2(4, 0), new Jal_table2(5, 3),
    new Jal_table2(7, 5), new Jal_table2(3, -3), new Jal_table2(10, 9), new Jal_table2(4, -7),
        new Jal_table2(5, -15),
    new Jal_table2(6, -31), new Jal_table2(7, -63), new Jal_table2(8, -127),
    ...
    new Jal_table2(9, -255), new Jal_table2(10, -511), new Jal_table2(11, -1023),
        new Jal_table2(12, -2047), new Jal_table2(13, -4095),
    new Jal_table2(16, -32767), new Jal_table2(3, 0), new Jal_table2(5, 3), new Jal_table2(7, 5),
        new Jal_table2(3, -3),
    new Jal_table2(10, 9), new Jal_table2(4, -7), new Jal_table2(5, -15),
        new Jal_table2(16, -32767), new Jal_table2(3, 0),
    new Jal_table2(5, 3), new Jal_table2(7, 5), new Jal_table2(3, -3), new Jal_table2(10, 9),
        new Jal_table2(4, -7),
    new Jal_table2(5, -15), new Jal_table2(16, -32767), new Jal_table2(3, 0), new Jal_table2(5, 3),
        new Jal_table2(7, 5),
    new Jal_table2(3, -3), new Jal_table2(10, 9), new Jal_table2(4, -7), new Jal_table2(5, -15),
        new Jal_table2(16, -32767),
    new Jal_table2(3, 0), new Jal_table2(5, 3), new Jal_table2(7, 5), new Jal_table2(3, -3),
        new Jal_table2(10, 9),
    new Jal_table2(4, -7), new Jal_table2(5, -15), new Jal_table2(16, -32767), new Jal_table2(3, 0),
        new Jal_table2(5, 3),
    new Jal_table2(7, 5), new Jal_table2(3, -3), new Jal_table2(10, 9), new Jal_table2(4, -7),
        new Jal_table2(5, -15),
    new Jal_table2(16, -32767), new Jal_table2(3, 0), new Jal_table2(5, 3), new Jal_table2(7, 5),
    ...
    new Jal_table2(5, 3), new Jal_table2(7, 5), new Jal_table2(3, -3), new Jal_table2(10, 9),
        new Jal_table2(4, -7),
    new Jal_table2(5, -15), new Jal_table2(16, -32767), new Jal_table2(2, 0), new Jal_table2(5, 3),
        new Jal_table2(7, 5),
    new Jal_table2(16, -32767), new Jal_table2(2, 0), new Jal_table2(5, 3), new Jal_table2(7, 5),
        new Jal_table2(16, -32767),
    new Jal_table2(2, 0), new Jal_table2(5, 3), new Jal_table2(7, 5), new Jal_table2(16, -32767),
        new Jal_table2(2, 0),
    new Jal_table2(5, 3), new Jal_table2(7, 5), new Jal_table2(16, -32767)
  };

  private static final Jal_table2 alloc_1[] = {
    new Jal_table2(4, 0),
    new Jal_table2(5, 3),
    new Jal_table2(3, -3),
    new Jal_table2(4, -7),
    ...
    new Jal_table2(8, -127),
    new Jal_table2(9, -255),
    new Jal_table2(10, -511),
    new Jal_table2(11, -1023),
    new Jal_table2(12, -2047),
    new Jal_table2(13, -4095),
    new Jal_table2(14, -8191),
    new Jal_table2(15, -16383),
    new Jal_table2(16, -32767),
    new Jal_table2(4, 0),
    new Jal_table2(5, 3),
    new Jal_table2(3, -3),
  ...
  private static final Jal_table2 alloc_2[] = {
    new Jal_table2(4, 0),
    new Jal_table2(5, 3),
    new Jal_table2(7, 5),
    new Jal_table2(10, 9),
  ...
  private static final Jal_table2 alloc_3[] = {
    new Jal_table2(4, 0),
    new Jal_table2(5, 3),
    new Jal_table2(7, 5),
    new Jal_table2(10, 9),
  ...
  private static final Jal_table2 alloc_4[] = {
    new Jal_table2(4, 0),
    new Jal_table2(5, 3),
    new Jal_table2(7, 5),
    new Jal_table2(3, -3),
  ...
  private static final Jal_table2 tables[ /*5*/][] = {alloc_0, alloc_1, alloc_2, alloc_3, alloc_4};
  private static final int sblims[ /*5*/] = {27, 30, 8, 12, 30};

  private static final void II_select_table(final Jframe fr) {
    int table;
  ...
  static final int decode_layer2_frame(
      final Jmpstr_tag mp,
      final Object pcm_sample,
      final int[] pcm_point,
      final Isynth synth) { // java: added synth to fix the bug
    final float fraction[][][] =
        new float[2][4][Jmpg123.SBLIMIT]; /* pick_table clears unused subbands */
    final Jsideinfo_layer_II si = new Jsideinfo_layer_II();
