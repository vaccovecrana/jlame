...
import io.vacco.jlame.spi.file.EncoderFileFormatType;
  ...
  public static void main(final String[] args) {
    ...
    try {
      ...
      if (!AudioSystem.isConversionSupported(new AudioFormat.Encoding("MPEG"), af)) {
        System.err.println("Sorry, conversion to Mpeg not supported");
        System.exit(1);
        return;
      }
      ...
      AudioSystem.write(
          ins, new EncoderFileFormatType("MPEG", "mp3", EncoderFileFormatType.VBR, 2f), outs);
